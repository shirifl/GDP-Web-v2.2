...
import { Arrow, FinalCTA, MediaPlaceholder, PageHeader, Reveal } from "../components.jsx";
              ...
              <Reveal key={active}>
                <div className="gp-card" style={{ padding: 0 }}>
                  ...
                  <div style={{ padding: 36 }}>
                    ...
                    <div style={{ marginTop: 32, paddingTop: 24, borderTop: "1px solid rgba(255,255,255,0.08)", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                      <div>
