    ...
    <div className="page-fade">
      ...
      <section className="gp-section" style={{ paddingTop: 24 }}>
        <div className="gp-container">
          <div className="gp-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start", borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 56 }}>
            <Reveal>
            ...
            <Reveal delay={2}>
              <div className="gp-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, border: "1px solid rgba(255,255,255,0.08)" }}>
                {[
