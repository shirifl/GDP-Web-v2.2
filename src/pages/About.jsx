  ...
  return (
    <section className="gp-section">
      <div className="gp-container">
        <div className="gp-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80 }}>
          <Reveal>
      ...
      <div className="gp-container">
        ...
        <Reveal>
          <div style={{ position: "relative" }}>
            ...
            <div className="gp-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 32 }}>
              {phases.map((ph, i) => (
                <div key={ph.p}>
