  ...
  return (
    <section style={{ position: "relative", paddingTop: 140, paddingBottom: 80, overflow: "hidden" }}>
      ...
      <div className="gp-container" style={{ position: "relative" }}>
        <div className="gp-split" style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            <Reveal>
  ...
  return (
    <section className="gp-section" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
      <div className="gp-container">
        <div className="gp-split" style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 80, alignItems: "start", marginBottom: 72 }}>
          <Reveal>
  ...
  return (
    <section className="gp-section" style={{ background: "var(--ink-1000)", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
      <div className="gp-container">
        ...
        <Reveal>
          <div className="gp-grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 0, borderTop: "1px solid rgba(255,255,255,0.08)" }}>
            {services.map((s, i) => (
              <div key={s.code}
      ...
      <div className="gp-container">
        ...
        <Reveal>
          <div style={{ position: "relative" }}>
            ...
            <div className="gp-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 28 }}>
              {steps.map((s, i) => (
                <div key={i}>
                  <div style={{
...
function CapabilitiesBand() {
  ...
  return (
    <section className="gp-section" style={{ background: "var(--ink-1000)", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
      <div className="gp-container">
        <div className="gp-split" style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 80, alignItems: "start", marginBottom: 48 }}>
          <Reveal>
        ...
        <Reveal>
          <div className="gp-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0, border: "1px solid rgba(255,255,255,0.08)" }}>
            {caps.map((c, i) => (
              <div key={i} style={{
                padding: "24px 22px",
...
function IndustriesStrip({ onNavigate }) {
  ...
  return (
    <section className="gp-section-tight" style={{ background: "var(--ink-1000)", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
      <div className="gp-container">
        <div className="gp-split" style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 64, alignItems: "center" }}>
          <Reveal>
  ...
  return (
    <section className="gp-section">
      <div className="gp-container">
        ...
        <div className="gp-grid-3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
          {posts.map((p, i) => (
